...
class BaiduBannerAdView extends StatefulWidget {
  ...
  final double width;
  final double height;
  final BaiduAdBannerCallBack? callBack;
  ...
  /// [height] 高
  ///
  /// [callBack] 回调 [BaiduAdBannerCallBack]
  const BaiduBannerAdView(
      {Key? key,
  ...
  @override
  _BaiduBannerAdViewState createState() => _BaiduBannerAdViewState();
}

class _BaiduBannerAdViewState extends State<BaiduBannerAdView> {

  String _viewType = "com.gstory.baiduad/BannerAdView";
